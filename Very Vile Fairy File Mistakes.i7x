...
"call cree"	in-fun-fen rule	leteq	--	"You need something simpler than an unusual language here."
...
"mit/mitt mound"	in-pit-pound rule	partplus	--	"The hit hound won't need to go chasing after that."
"crash crap"	in-po-pit rule	letminus	--	"Profanity isn't necessary, here. Even minor ones." [start po' pit] [?? all this needs to be tested a lot]
...
"ho/hoe hit"	in-po-pit rule	letplus	if-grit-ungrown rule	"You half-heartedly consider violence, but you probably need thinking, instead."
"lo/low lit"	in-po-pit rule	letplus	if-grit-ungrown rule	"You wonder if the dark, or a racy novel, will help. Probably not."
"bo/bow bit"	in-po-pit rule	letplus	if-grit-ungrown rule	"There's no fiddly bit like a bow. You showed a bit of persistence there looking for it, though."
"rash wrap/rap"	in-po-pit rule	letplus	if-grit-ungrown rule	"You don't need a rash, or rash actions. You need a more mature response, you reckon."
"slow slit"	in-po-pit rule	leteq	if-grit-ungrown rule	"You can't see where to make a cut, and you have nothing to make a cut with."
"bro brit"	in-po-pit rule	leteq	if-grit-ungrown rule	"You can't see where to make a cut, and you have nothing to make a cut with."
"know/no knit/nit"	in-po-pit rule	partplus	if-grit-ungrown rule	"You look for details to understand, but you might want to go in for a bigger picture.""show shit"	in-po-pit rule	leteq	if-grit-ungrown rule	"Profanity doesn't work here."
"so sit"	in-po-pit rule	letplus	if-grit-ungrown rule	"You sit and pout. It doesn't help."
"lash lap"	in-po-pit rule	leteq	if-grit-ungrown rule	"You bang your fists against your pockets. It sort of helps, you guess."
"woe/whoa/whoah wit"	in-po-pit rule	--	clue-whoah-wit rule	"Clever complaining will make you feel better but won't do anything."
...
"signed salt"	in-vined-vault rule	letboth	--	"Alas, the walls of the vault do not turn to salt. Perhaps they still have a structural deficiency, though."
