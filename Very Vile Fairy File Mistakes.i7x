...
"jig jag"	mist-bag-hint rule	false	3	3	--	"You aren't up for dancing." [this is referred to explicitly when you BIG BAG, so I'll skip it]
...
"lo/low late"	go-gate-vis rule	false	--	--	--	"You feel you are on the right path to disabling the go gate.[leetclue of partplus]"
...
"stow steeled"	in-foe-field rule	false	5	7	--	"You don't have anything steely to stow."
...
"bark biff"	in-fun-fen rule	false	5	6	--	"A cruel voice calls from the distance 'Hello, McFly? Hello! You need another L for that!'"
"gaper guile"	vapor-vile-vis rule	false	5	4	--	"You stare at the vapor but get no insight[kind-of-paper]."
"taper/tapir tile"	vapor-vile-vis rule	false	5	4	--	"No tile appears, but on the bright side, neither does a charging tapir[kind-of-paper]."
"aper isle"	vapor-vile-vis rule	false	5	4	--	"You are not teleported to somewhere similar to the Fun Fen."
...
"massed/mast map"	in-gap-with-cap rule	false	4	3	--	"You don't need a map--the gap is pretty straightforward. You just need to make a challenge the right way and fight whatever guardian is here."
...
"buy/by ball"	got-gear-hot-here rule	false	3	3	--	"You wonder what sort of mall this is, without a sports store[shawl-lol]."
"pie paul/pall"	got-gear-hot-here rule	false	3	3	--	"You bemoan the lack of a food court in the mall[shawl-lol]."
"my mall/maul"	got-gear-hot-here rule	false	3	3	--	"You show suitable ambition and aggression for an adventurer[shawl-lol]."
"why wall"	got-gear-hot-here rule	false	3	3	--	"You complain to nobody in particular about the number of dead ends in the mall[shawl-lol]."
"cry crawl"	got-gear-hot-here rule	false	3	3	--	"You feel overcome with emotion[shawl-lol]."
"mere mull"	beer-bull-by rule	false	4	4	--	"The beer bull is not impressed by thoughtfulness." [start here hull]
"gear gull"	beer-bull-by rule	false	4	4	--	"Spoiler: once you get rid of the bull, a gear gull will appear."
"leer lull"	beer-bull-by rule	false	4	4	--	"The beer bull does not stop looking aggressively at you."
"peer/pier pull"	beer-bull-by rule	false	4	4	--	"No, you can't bring the bull down with peer pressure."
"cake cap"	in-lake-lap rule	false	4	3	--	"No edible headgear appears." [start lake lap]
"crake crap"	in-lake-lap rule	false	4	3	--	"No bird droppings provide a trail."
"fake fap"	in-lake-lap rule	false	4	3	--	"You make a rude gesture, for whatever good it does."
...
"sift siever"	in-rift-river rule	false	4	5	--	"That would be a good tool in a cooking simulation, but the Leet Learner is more useful."
...
"dirk dell"	need-gel rule	false	4	4	--	"You don't need an olde tyme adventure with daggers and stuff." [start shirk shell]
"urkel"	need-gel rule	false	--	--	--	"You hear an annoying laugh in the distance."
"urk/erk ell"	need-gel rule	false	--	--	--	"Your odd interjections don't get any gel back in the tube. You need better actions."
"smirk smell"	need-gel rule	false	4	4	--	"No, you don't want that."
"turk tell"	need-gel rule	false	4	4	--	"You wonder breifly how that automaton back in the 18th century played chess, anyway."
"coughed canned"	in-soft-sand rule	false	--	--	--	"You try to suppress a cough while avoiding any sudden turndown in fortune." [start soft sand]
"lark lore"	in-stark-store rule	false	4	4	--	"This is no time for jokes! Or bird-watching." [start stark store]
"bark bore/boar"	in-stark-store rule	false	4	4	--	"You don't need to make a tree or summon anything tiresome or porcine."
"park pore/poor"	in-stark-store rule	false	4	4	--	"The store cannot become outdoorsy. Or a parking lot."
"shark shore"	in-stark-store rule	false	4	4	--	"No, you don't need more danger here."
"snark snore"	in-stark-store rule	false	4	4	--	"You pretend you've already done much harder things. It gives you confidence, or something close enough."
"spark spore"	in-stark-store rule	false	4	4	--	"Biological warfare is probably dangerous."
...
"sorel/sorrel sage"	coral-cage-around rule	false	5	4	--	"Someone not just wise but ethical is behind the coral cage[if sage sea is visited]. Besides, there's already the sage sea[end if]."
"immoral image"	coral-cage-around rule	false	5	4	--	"You sort of need the opposite. I suspect you know this and are just trying to see what happens."
...
"signed see/sea"	tram-first-puzzle rule	false	4	2	--	"You're still reacting to FIND FEE. You need to look inwards."
...
"wined/wind walt"	in-vined-vault rule	false	4	5	--	"A drinking buddy you can play practical jokes on won't be any help here."
"goring goat"	boat-or-float rule	false	6	4	float-present rule	"You don't need an aggressive animal sidekick."
...
"mooring moat"	boat-or-float rule	false	6	4	float-present rule	"The seacraft seem to anchor themselves okay here."
"island ale/ail"	in-violent-vale rule	false	--	--	--	"No need to drink or get an island disease."
"stet stood"	in-wet-wood rule	false	3	4	--	"No proofreading is necessary."
...
"spining spore"	in-whining-war rule	false	7	5	--	"Your foray into speculative biology goes nowherre."
...
to say kind-of-paper: say ". Now you've organized the pile, maybe its details are more important to read or examine"

to say shawl-lol: if lie-lol is true, say ". The shawl seems worthless as ever, maybe not even worth changing to something else[one of][or], but it sure is good for practice[stopping]"
...
this is the clue-worst-wave rule:
	if tool tap is off-stage:
		say "[leetclue of letminus].";
		the rule fails;
...
this is the need-gel rule: if player is in shirk shell and jerk gel is in shirk shell, the rule succeeds;
