...
mist-cmd(topic)	mist-rule	w1let	w2let	leet-rule	mist-txt
"brig brag"	trivially true rule	3	3	mist-bag-hint rule	"Good guys don't brag about [if player is in vined vault]being[else if vined vault is visited]having been[else]if they were ever[end if] in jail!" [start general mistakes]
"swig swag"	trivially true rule	3	3	mist-bag-hint rule	"There's no time to be drinking here!"
...
"shy shawl"	signable-loc rule	--	--	--	"You'll need better clothing than that to get through things."
"try tall"	signable-loc rule	--	--	--	"The wry wall does not grow."
"bell born"	hell-horn-near rule	4	4	--	"There's enough noise right now." [start airy isle]
"swell sworn"	hell-horn-near rule	4	4	--	"That might augment the hell horn."
"nursed knave"	in-curst-cave rule	5	5	clue-worst-wave rule	"You don't need any more of that." [start curst cave]
"live leap"	hive-heap-near rule	4	4	--	"The leap wouldn't be live for very long." [start fun fen]
"call cree"	in-fun-fen rule	4	4	--	"You need something simpler than an unusual language here."
...
"fast fap"	in-gassed-gap rule	4	3	--	"Stop that! While this is, uh, a solo adventure, this is not AIF. We're not THAT sort of juvenile, here." [start gassed gap]
"last lap"	in-gap-with-cap rule	4	3	--	"It will be the last lap one day. But you need a different action to get to this finality."
"passed/past pap"	in-gassed-gap rule	4	3	--	"You don't need to look back on what a trashy adventure this has been. Well, not in front of me." [?? cap cast yet?]
"razzed rap"	in-gassed-gap rule	4	3	--	"There's enough bad music in this game if you know where to look."[?? if-then for if cap is moot]
"sassed sap"	in-gassed-gap rule	4	3	--	"You look for someone who has recently lost an argument, but nobody turns up."
"mit/mitt mound"	in-pit-pound rule	3	5	--	"[if hit hound is moot]The hit hound won't need to go chasing after that[else]The pit pound doesn't need clutter like that[end if]."
"crash crap"	in-po-pit rule	4	3	--	"Profanity isn't necessary, here. Even minor ones." [start po' pit] [?? all this needs to be tested a lot]
"crow crit"	in-po-pit rule	4	4	if-grit-ungrown rule	"You wait for a little bird to give advice, but nothing happens."
"foe fit"	in-po-pit rule	4	4	if-grit-ungrown rule	"Complaining and speculation about who or what put you there won't help."
"go get/git"	in-po-pit rule	4	4	if-grit-ungrown rule	"You have no-one to order around, not that it'd do any good."
"ho/hoe hit"	in-po-pit rule	4	4	if-grit-ungrown rule	"You half-heartedly consider violence, but you probably need thinking, instead."
"lo/low lit"	in-po-pit rule	4	4	if-grit-ungrown rule	"You wonder if the dark, or a racy novel, will help. Probably not."
...
"prim pram"	in-trim-tram rule	4	4	--	"That worked in Trinity, but this game isn't Trinity. For better or, more likely, for worse."
"slim slam"	in-trim-tram rule	4	4	--	"That might be cool, to make the puzzle a slam dunk and lose the last few pounds, but it's not sneaky enough. You must be close, though."
"bean bass"	mass-near rule	5	5	--	"You could use a delicious meal, but perhaps there is something even simpler the mean mass can become." [start vined vault]
"clean class"	mass-near rule	5	5	--	"You can't help but feel the mean mass could be more wholesome, but that's not quite the right way to do things. It doesn't feel quite natural enough."
"glean glass"	mass-near rule	5	5	--	"No, there's no hidden window you overlooked."
"hind halt"	in-vined-vault rule	4	5	--	"You do feel sort of paranoid here, but fortunately, nothing is behind you or needs to stop."
"lean lass"	mass-near rule	5	5	--	"This isn't that sort of game."
"mind malt"	mass-near rule	--	--	--	"The mind malt is gone. You have to rely on yourself!"
"signed salt"	in-vined-vault rule	4	5		--	"Alas, the walls of the vault do not turn to salt. Perhaps they still have a structural deficiency, though."
"wined walt"	in-vined-vault rule	4	5	--	"A drinking buddy won't help here."
"cake cap"	shore-shined rule	4	3	--	"No edible headgear appears." [start whining war] [?? this is all wrong now]
"fake fap"	shore-shined rule	4	3	--	"You make a rude gesture, for whatever good it does."
"signing sore"	in-whining-war rule	7	5	--	"You make a rude gesture, for whatever good it does."
...
"card cat"	hat-or-mat rule	4	3	no-hardhat rule	"Not very practical." [general unsorted]
