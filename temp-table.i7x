...
"filly foaling"	trivially true rule	false	--	--	--	"Caring for young animals is a good thing but beyond this game's scope."[start 1 general mistakes]
...
"tough toll"	--	false	--	--	--	"You groan about how heavy your inventory is."[start general stuff]
...
"lumped luster/lustre"	cluster-near rule	false	7	6	--	"The cluster would still be in the way if it were shiny." [?? minor point][start been buggin]
...
"teen tuggin"	in-been-buggin rule	false	4	6	--	"Dealing with the shame of having done, er, THAT is beyond the scope of this game." [?? lean-mean-left rule]
...
"grinding grays"	before-grays rule	false	7	4	blaze-before-maze rule	"Even if it were duller, you'd still be left with a [if blaze-ways is false]hot blaze[else]tricky maze[end if]." [?? still when in winding ways][start blinding blaze]
"binding bays/baize"	in-blaze-ways rule	false	7	4	blaze-before-maze rule	"You need to find your way here, not get more tied up."
...
"nursed nave/knave"	in-curst-cave rule	false	5	5	need-first-fave rule	"You don't need to nurse a bad guy or a religious place."
...
"mo mealed"	in-foe-field rule	false	6	6	shield-unshown rule	"Alas, no food magically appears. You [if gold guard is moot]did what you needed[else]need a more fighting stance[end if]."[start foe field]
...
"crane crescent"	peasant-around rule	false	5	8	--	"No bird or complex machinery drops by to sweep the pain peasant away."
...
"wall whee"	in-fun-fen rule	false	4	4	--	"You want to have fewer things in your way, not more. Just spitballing here."
...
"should shun"	good-gun-here rule	false	4	3	--	"Gentle rebukes won't work. You need to make the gun less dangerous."[start gassed gap]
...
"blot blear"	got-gear-hot-hear rule	false	4	4	not-near-yet rule	"You don't need to make this store more dreary."[start got gear hot here]
"bought beer"	got-gear-hot-hear rule	false	4	4	not-near-yet rule	"Alas, the mall has no liquor license."
"fought fear"	got-gear-hot-hear rule	false	4	4	not-near-yet rule	"With nobody around to kibitz, you reflect on the barriers you've broken through to get this far."
...
"gear gull"	beer-bull-by rule	false	4	4	need-dull-or-null rule	"Spoiler: once you get rid of the bull, a gear gull will appear."[start here hull]
"leer lull"	beer-bull-by rule	false	4	4	need-dull-or-null rule	"The beer bull does not stop looking aggressively at you."
"mere mull"	beer-bull-by rule	false	4	4	need-dull-or-null rule	"The beer bull is not impressed by thoughtfulness."
"peer/pier pull"	beer-bull-by rule	false	4	4	need-dull-or-null rule	"No, you can't bring the bull down with peer pressure."
"fake fap"	cap-or-lap rule	false	4	3	lap-not-cap rule	"You make a rude gesture, for whatever good it does."[start lake lap]
...
"cake cap"	lap-not-cap rule	false	4	3	--	"No edible headgear appears."
"blots blame"	ganksta-nearby rule	false	4	4	--	"There's another way to insult the tattoo as bad art. You're very close."[start history hall]
...
"cake key"	in-lakes rule	false	4	3	need-fake-fee rule	"Ooh! That'd be nice and tasty. But you don't need that right now."[start lake lea]
"bit bound"	in-pit-pound rule	false	3	5	not-fit-yet rule	"Now you mention it, you [if found-fit is false]do[else]did[end if] feel a bit restricted here. Expressing your feelings helps a bit! You think."[start pit pound]
"mit/mitt mound"	in-pit-pound rule	false	3	5	not-fit-yet rule	"[if hit hound is in pit pound]The hit hound won't need to go chasing after that[else]The pit pound doesn't need clutter like that[end if]."
...
"clash clap"	in-po-pit rule	false	4	3	--	"Your vehement applause goes unheeded. But perhaps other violence might be more productive."[start po' pit]
...
"eel ear/ere"	in-real-rear rule	false	--	--	--	"You don't need an eel, or a piece of one, to electrify things right now."[start real rear]
...
"cage key"	key-or-rear rule	false	--	--	--	"[if cage key is off-stage]You correctly guessed what's in the Sage Sea, but you need to be wise, not clever, to earn it. [cagekey-prog][else]You already got the key[end if]."
...
"drift driver"	in-rift-river rule	false	4	5	--	"No vehicle comes to take you across the river. And that doesn't quite rhyme, anyway[rift-need]."[start rift river]
"lift liver"	in-rift-river rule	false	4	5	--	"You gain no nutritious meat nor uplifting advice. But you must be close[rift-need]."
...
"urkel"	gel-or-shell rule	false	--	--	--	"You hear an annoying laugh in the distance." [?? test this special case. What if there is a mistaken rule we don't need and there are no numbers?][start shirk shell]
"dirk dell"	gel-or-shell rule	false	4	4	need-work-well rule	"You don't need an olde tyme adventure with daggers and stuff."
...
"bark bore/boar"	in-stark-store rule	false	4	4	need-mark-more rule	"You don't need to make a tree or summon anything tiresome or porcine."[start stark store]
"hark whore"	in-stark-store rule	false	4	4	need-mark-more rule	"Stop that."
...
"immoral image"	in-storeall-stage rule	false	5	4	coral-cage-around rule	"You sort of need the opposite. I suspect you know this and are just trying to see what happens."[start store all stage]
...
"dim dam/damn"	in-trim-tram rule	false	4	4	--	"You need fewer blockages and/or minor curses, not more."[start trim tram]
...
"bind be"	tram-first-puzzle rule	false	4	2	--	"Your incantation fails. Perhaps something more straightforward and inward-looking would work better."
...
"fining four"	in-whining-war rule	false	7	5	need-dining-door rule	"You don't need to summon people that may audit you."[start whining war]
...
"signing sore"	in-whining-war rule	false	7	5	need-dining-door rule	"You make a rude gesture, for whatever good it does." [?? this may need to be fixed shore/poor]
...
"lold lard"	in-yold-yard rule	false	--	--	--	"Fat jokes aren't funny, self-depreciating or otherwise."[start yold yard]
...
"perking pump"	lump-known rule	false	--	--	--	"I don't want to know."[start zzz last stuff][start ]
